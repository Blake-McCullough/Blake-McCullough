<!-- logoColor=fbfbfb&color=9200ff  -->
  ...
  My name is Blake McCullough and I'm a student at TAFE doing a CERT IV in Networking with a heart for passion and coding!. I'm from Australia, living in Perth and currently working at doing an internship with [HyprFire](https://www.hyprfire.com/). I have developed an app for the [VRML API](https://vrmasterleague.com/), which can be downloaded on the [Google Play Store](https://play.google.com/store/apps/details?id=com.SpoiledKitten.VRML), with plans to release on IOS!
